...
RSpec.describe "/game_maps", type: :request do
  ...
  # GameMap. As you add validations to GameMap, be sure to
  ...
  describe "GET /index" do
    it "renders a successful response" do
      GameMap.create! valid_attributes
      get game_maps_url
  ...
  describe "GET /show" do
    it "renders a successful response" do
      game_map = GameMap.create! valid_attributes
  ...
  describe "POST /create" do
    context "with valid parameters" do
      ...
      it "redirects to the created game_map" do
        post game_maps_url, params: { game_map: valid_attributes }
        expect(response).to redirect_to(game_map_url(GameMap.last))
      end
    end
